...
import 'prayer_times/bloc/bindings.dart';
import 'prayer_times/bloc/prayer_times_getx.dart';
import 'prayer_times/calculation_method.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void fetch()async{
    ...
    Get.lazyPut(()=>PrayerTimesController(prayerTimesRepository));
  }
